...
export default function Navbar() {
  ...
  return (
    ...
    >
      <Link href="/">
        <span className="text-xl font-bold text-indigo-600">Teametix</span>
      </Link>
      ...
      >
        ...
        <Link
          href="/contact"
          className="px-5 h-11 rounded-md bg-indigo-600 hover:bg-indigo-700 text-white transition inline-flex items-center"
        >
          Contact
        </Link>
        <button
